         ...
         <div class="inner_container">
            ...
            ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="jumlah_masuk" placeholder="Masukan Jumlah Masuk Barang">
...
if (isset($_POST['simpan'])) {
   ...
   $jumlah_masuk = $_POST['jumlah_masuk'];
      ...
      $sql = mysqli_query($kon, "INSERT INTO barang_msk VALUES('', '$id', '$jumlah_masuk', CURDATE())");
      if ($sql) {
         echo "
         <script>
